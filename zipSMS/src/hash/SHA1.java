...
public class SHA1 {
    ...
    public String shaAlgorithm(ArrayList<BigInteger> blocks){        
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        SHA1 sha = new SHA1(str, msg.length()*8);
        byte[] padding = sha.paddingBits();
               
        System.out.println("My SHA-1");
        ArrayList<BigInteger> blocks = sha.breakToBlock512(padding);        
        System.out.println(sha.shaAlgorithm(blocks));
        
        System.out.println("Java SHA-1");
        MessageDigest cript = MessageDigest.getInstance("SHA-1");
              cript.reset();
              cript.update(str);
              BigInteger passwordHash = new BigInteger(1, cript.digest());
              System.out.println(passwordHash.toString(16));
